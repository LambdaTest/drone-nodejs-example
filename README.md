# Run Node.js Tests with Drone CI on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run Node.js Selenium tests triggered through Drone CI on the TestMu AI (Formerly LambdaTest) cloud.
...
- Drone CI configured for your repository
...
```bash
git clone https://github.com/LambdaTest/drone-nodejs-example.git
cd drone-nodejs-example
npm install
```
...
Or trigger the pipeline via Drone CI — the `.drone.yml` in the repository defines the pipeline steps.
